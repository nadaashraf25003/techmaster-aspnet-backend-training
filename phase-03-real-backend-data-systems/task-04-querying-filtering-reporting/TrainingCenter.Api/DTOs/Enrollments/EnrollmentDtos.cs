...
{
    /// <summary>
    /// Filter by Training Track ID (Query 19: trackId=1).
    /// </summary>
    ...
    /// <summary>
    /// Filter by Enrollment Status (Query 19: status=Active, Pending, Completed, Cancelled).
    /// </summary>
    [FromQuery(Name = "status")]
    public EnrollmentStatus? Status { get; set; }

    /// <summary>
    /// Filter by Payment Status (Query 19: paymentStatus=Paid, Completed, Pending, Failed).
    /// </summary>
    [FromQuery(Name = "paymentStatus")]
    public string? PaymentStatus { get; set; }

    /// <summary>
    /// Filter by enrollment start date range.
    /// </summary>
    [FromQuery(Name = "from")]
    public DateTime? From { get; set; }

    /// <summary>
    /// Filter by enrollment end date range.
    /// </summary>
    [FromQuery(Name = "to")]
    public DateTime? To { get; set; }

    /// <summary>
    /// Search term matching student name, student email, or track title.
    /// </summary>
