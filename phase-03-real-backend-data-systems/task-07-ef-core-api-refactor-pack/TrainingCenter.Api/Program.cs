...
builder.Services.AddDbContext<TrainingCenterDbContext>(options =>
{
    ...
    {
        options.UseInMemoryDatabase("TechMaster_Phase03_Task07_RefactorDb");
    }
});

// Support legacy AppDbContext injection for BadEnrollmentsController
builder.Services.AddScoped<AppDbContext>(sp =>
{
    var options = sp.GetRequiredService<DbContextOptions<TrainingCenterDbContext>>();
...
app.UseSwaggerUI(c =>
{
    c.SwaggerEndpoint("/swagger/v1/swagger.json", "TechMaster Task 07 Refactored API v1.0");
    c.RoutePrefix = string.Empty;
    c.DocumentTitle = "TechMaster Task 07 - EF Core API Refactor Pack";
});
...
// Ensure Database initialization & Seed Data
