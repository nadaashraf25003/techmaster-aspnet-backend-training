...
public class GlobalExceptionHandlingMiddleware
{
    ...
    public async Task InvokeAsync(HttpContext context)
    {
        ...
        {
            _logger.LogWarning("Business rule validation exception caught: {Message} with HTTP {StatusCode}", ex.Message, ex.StatusCode);
        ...
        catch (Exception ex)
        {
            ...
            await HandleExceptionAsync(context, (int)HttpStatusCode.InternalServerError, "An unexpected server error occurred.", new List<string> { ex.Message });
        }
    }
