    ...
    public static async Task SeedAsync(TrainingCenterDbContext context)
    {
        ...
        var instructors = new List<Instructor>
        {
            ...
            new Instructor
            {
                ...
                HourlyRate = 400.00m,
                IsActive = false // Rule T4 validation test target
            }
        };
        ...
        {
            // Track 1: Standard InProgress Track
            new TrainingTrack
            {
            ...
            // Track 2: FULL Track (Capacity = 2, 2 active enrollments -> Rule T5 target)
            new TrainingTrack
            {
            ...
            // Track 3: CLOSED Track (Status = Closed -> Rule T6 target)
            new TrainingTrack
            {
        ...
        var students = new List<Student>
        {
            ...
            new Student
            {
                ...
                Address = "Giza",
                IsActive = false // Rule S5 validation target (inactive student)
            },
            new Student
            {
        ...
        var enrollments = new List<Enrollment>
        {
            ...
            // Enrollment 1: Ahmed -> NET-BE (Active, Partial Payment: 5,000 paid / 8,500 total, remaining = 3,500)
            new Enrollment
            {
            ...
            // Enrollment 2: Salma -> REACT-FULL (Active, fills seat 1 of 2)
            new Enrollment
            {
            ...
            // Enrollment 3: Omar -> REACT-FULL (Active, fills seat 2 of 2 -> Track is now FULL!)
            new Enrollment
            {
            ...
            // Enrollment 4: Mariam -> AI-ML (Completed -> Rule E4 target: cannot cancel completed enrollment)
            new Enrollment
            {
            ...
            // Enrollment 5: Khaled -> NET-BE (Cancelled -> Rule E5: does not count towards active capacity!)
            new Enrollment
            {
        ...
        var payments = new List<Payment>
        {
            ...
            // Payment 2: Ahmed (Partial 5,000 EGP)
            new Payment
            {
            ...
            // Payment 3: Salma (Full 5,000 EGP)
            new Payment
            {
            ...
            // Payment 5: Mariam (Full 10,500 EGP)
            new Payment
            {
