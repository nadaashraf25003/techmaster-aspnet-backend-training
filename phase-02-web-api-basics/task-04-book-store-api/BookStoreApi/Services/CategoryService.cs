...
public class CategoryService : ICategoryService
{
    ...
    private void SeedInitialCategories()
    {
        var seeds = new List<Category>
        {
            new()
            {
                CategoryId = _nextId++,
                Name = "Fiction",
                Description = "General literature containing stories created from the imagination.",
                IsActive = true,
            ...
            new()
            {
                CategoryId = _nextId++,
                Name = "Fantasy",
                Description = "Speculative fiction set in a fictional universe, often inspired by real world myth.",
                IsActive = true,
            ...
            new()
            {
                ...
                Description = "Speculative fiction that typically deals with imaginative concepts such as futuristic science.",
                IsActive = true,
            ...
            new()
            {
                CategoryId = _nextId++,
                Name = "Biography",
                Description = "Detailed description of a person's life (Inactive by default).",
                IsActive = false,
    ...
    public Task<bool> IsCategoryActiveAsync(int id)
    {
        lock (_lock)
        {
            var isActive = _categories.Any(c => c.CategoryId == id && c.IsActive);
    ...
    private static CategoryResponse MapToDto(Category category, int booksCount = 0)
    {
